{{-- resources/views/p2m/kunjungan_wisata.blade.php --}}
@extends('layout.p2m')
...
<div class="flex justify-center py-10">
    <div class="bg-white w-full max-w-6xl rounded-xl shadow-md border border-gray-200 p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
            ...
            <form action="{{ route('p2m.kunjungan_wisata.indexWisata') }}" method="GET"
                ...
                <a href="{{ route('p2m.laporan.export.kunjungan_wisata', ['bulan' => request('bulan'), 'tahun' => request('tahun')]) }}"
                ...
                <tbody>
                    @forelse($wisata as $item)
                        ...
                        <div id="modalDetail{{ $item->id }}"
                            ...
                            <div class="bg-white w-11/12 max-w-2xl rounded-xl shadow-lg p-6 max-h-[90vh] overflow-y-auto">
                                ...
                                <div class="space-y-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex gap-3">
                                            ...
                                            {{-- Lihat File --}}
                                            <a href="{{ route('p2m.kunjungan_wisata.view_surat', $item->id) }}"
                                                target="_blank"
                                            ...
                                            {{-- Download File --}}
                                            <a href="{{ route('p2m.kunjungan_wisata.download_surat', $item->id) }}"
