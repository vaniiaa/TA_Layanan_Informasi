{{-- resources/views/admin/p2m/sosialisasi.blade.php --}}
...
<div class="flex justify-center py-10">
    <div class="bg-white w-full max-w-6xl rounded-xl shadow-md border border-gray-200 p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
            ...
            {{-- Filter Bulan & Tahun + Unduh (TIDAK DIHAPUS) --}}
            <form action="{{ route('admin.sosialisasi.index') }}" method="GET"
                ...
                <a href="{{ route('admin.laporan.export.sosialisasi', ['bulan' => request('bulan'), 'tahun' => request('tahun')]) }}"
