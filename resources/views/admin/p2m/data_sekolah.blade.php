{{-- resources/views/admin/p2m/data_sekolah.blade.php --}}
                ...
                <tbody>
                    @foreach($data as $item)
                        <tr>
                            ...
                            <td>{{ $item->alamat }}</td>
                            <td>{{ ucfirst($item->status_sekolah) }}</td>
                            ...
                            <td class="flex gap-2">
                                ...
                                <form id="delete-form-{{ $item->id }}" method="POST"
                                    action="{{ route('admin.data_sekolah.delete', $item->id) }}"
                                    class="hidden">
                                    @csrf
                                    @method('DELETE')
                                </form>
                        ...
                        <div id="modalEdit{{ $item->id }}"
                            ...
                            <div class="bg-white w-full max-w-lg rounded-xl shadow-lg p-6">
                                ...
                                <form method="POST"
                                    action="{{ route('admin.data_sekolah.update', $item->id) }}">
                                    @csrf
                                    @method('PUT')
...
<div id="modalTambah" class="fixed inset-0 hidden z-[9999] bg-black/60 flex items-center justify-center">
    <div class="bg-white w-full max-w-lg rounded-xl shadow-lg p-6">
        ...
        <form method="POST" action="{{ route('admin.data_sekolah.store') }}">
            @csrf
