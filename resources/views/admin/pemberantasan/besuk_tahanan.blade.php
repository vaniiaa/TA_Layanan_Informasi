{{-- resources/views/admin/pemberantasan/besuk_tahanan.blade.php --}}
...
<div class="flex justify-center py-10">
    <div class="bg-white w-full max-w-6xl rounded-xl shadow-md border border-gray-200 p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
            ...
            <form action="{{ route('admin.pemberantasan.besuk_tahanan') }}" method="GET"
                ...
                <a href="{{ route('admin.laporan.export_besuk', ['bulan' => request('bulan'), 'tahun' => request('tahun')]) }}"
...
{{-- SEARCH SCRIPT: cari di tabel #dataTable --}}
<script>
