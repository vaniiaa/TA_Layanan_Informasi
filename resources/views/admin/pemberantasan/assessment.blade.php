{{-- resources/views/admin/pemberantasan/assessment.blade.php --}}
...
<div class="flex justify-center py-10">
    <div class="bg-white w-full max-w-6xl rounded-xl shadow-md border border-gray-200 p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
            ...
            {{-- Filter + Export --}}
            <form action="{{ route('admin.pemberantasan.assessment') }}" method="GET"
                ...
                <a href="{{ route('admin.assessment.export', ['bulan'=>request('bulan'),'tahun'=>request('tahun')]) }}"
