{{-- resources/views/pemberantasan/publikasi_berita.blade.php --}}
            ...
            <table id="dataTable" class="table table-zebra w-full text-sm">
                    ...
                    @foreach($publikasi as $item)
                        <tr>
                            ...
                            <td class="flex gap-2">
                                ...
                                <form id="delete-form-{{ $item->id }}" method="POST"
                                    action="{{ route('pemberantasan.publikasi.destroy', $item->id) }}"
                                    class="hidden">
                                    @csrf
                                    @method('DELETE')
                                </form>
                        ...
                        <div id="modalEdit{{ $item->id }}"
                           ...
                           <div class="bg-white w-full max-w-lg rounded-xl shadow-lg p-6 max-h-[90vh] overflow-y-auto">
                                ...
                                <form method="POST"
                                    action="{{ route('pemberantasan.publikasi.update', $item->id) }}"
                ...
                <div id="modalTambah"
                    ...
                    <div class="bg-white w-full max-w-lg rounded-xl shadow-lg p-6 max-h-[90vh] overflow-y-auto">
                        ...
                        <form action="{{ route('pemberantasan.publikasi.store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            ...
                            <div id="formInfografis" class="hidden">
                                <label class="font-semibold">Judul<span class="text-red-500">*</span></label>
                                <input name="judul_infografis" placeholder="Judul"
                                    class="input input-bordered w-full mb-2">
                                <label class="font-semibold">Deskripsi<span class="text-red-500">*</span></label>
                                <textarea name="deskripsi_infografis"
                                    class="textarea textarea-bordered w-full mb-2"></textarea>
                                <label class="font-semibold">Gambar<span class="text-red-500">*</span></label>
