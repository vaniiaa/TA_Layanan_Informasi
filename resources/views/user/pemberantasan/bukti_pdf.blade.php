{{-- resources/views/user/pemberantasan/bukti_pdf.blade.php --}}
<!DOCTYPE html>
<html lang="id">

<head>
    <meta charset="UTF-8">
    <title>Bukti Pendaftaran Besuk Tahanan</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p><strong>Bukti Pendaftaran Permohonan Besuk Tahanan</strong></p>
        </div>
        ...
        <div class="thank">
            <p>Terima kasih telah berpartisipasi dalam program Besuk Tahanan.</p>
