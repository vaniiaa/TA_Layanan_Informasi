{{-- resources/views/user/pemberantasan/bukti_pdf_assessment.blade.php --}}
<!DOCTYPE html>
<html lang="id">

<head>
    <meta charset="UTF-8">
    <title>Bukti Pendaftaran Assessment Terpadu</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p><strong>Bukti Pendaftaran Assessment Terpadu</strong></p>
        </div>

        <div class="info">
            <p><strong>Nama Pemohon:</strong> {{ $nama_lengkap }}</p>
            <p><strong>Tanggal Pendaftaran:</strong> {{ $tanggal }}</p>
            <p><strong>Status:</strong> Pendaftaran berhasil diterima oleh sistem.</p>
        </div>

        <div class="thank">
            <p>Terima kasih telah melakukan Pendaftaran Assessment Terpadu.</p>
