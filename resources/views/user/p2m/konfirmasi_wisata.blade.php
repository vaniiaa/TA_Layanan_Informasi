{{-- resources/views/user/p2m/konfirmasi_wisata.blade.php --}}
...
<div class="container mx-auto px-4 pt-32 pb-12 relative">
    ...
    <div class="flex justify-center pt-10">
        <a href="{{ route('wisata.downloadBukti') }}"
            class="bg-[#022D57] hover:bg-[#034077] transition text-white px-6 py-2 rounded-md mr-4">
            Unduh Bukti
        </a>
        <a href="{{ url('/') }}"
