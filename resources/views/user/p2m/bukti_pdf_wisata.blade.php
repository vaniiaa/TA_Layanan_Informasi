{{-- resources/views/user/p2m/bukti_pdf_wisata.blade.php --}}
<!DOCTYPE html>
<html lang="id">

<head>
    <meta charset="UTF-8">
    <title>Bukti Pendaftaran Wisata Edukasi</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p><strong>Bukti Pendaftaran Permohonan Wisata Edukasi</strong></p>
        </div>
        ...
        <div class="thank">
            <p>Terima kasih telah berpartisipasi dalam program Wisata Edukasi P4GN.</p>
